...
const WGPUTextureFormat WGPU_TEXTURE_FORMAT_to_Dawn[] = {
  ...
  WGPUTextureFormat_RGB10A2Uint, // WGPU_TEXTURE_FORMAT_RGB10A2UINT
...
void _wgpu_object_destroy(_WGpuObject* obj) {
  ...
  case kWebGPURenderBundle:
    wgpuRenderBundleRelease((WGPURenderBundle)obj->dawnObject);
    break;
...
void wgpu_adapter_request_device_async_simple(WGpuAdapter adapter, WGpuRequestDeviceCallback deviceCallback) {
  ...
  wgpu_adapter_request_device_async(adapter, &defaultDesc, deviceCallback, nullptr);
}
