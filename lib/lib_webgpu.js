...
//////////////////////////////////////////////////////////////////
  ...
  $wgpuReadDeviceDescriptor: function(descriptor) {
    ...
    return {
      ...
      'defaultQueue': wgpuReadQueueDescriptor(descriptor+36/*sizeof(WGpuSupportedLimits)*/),
      'requiredFeatures': wgpuReadFeaturesBitfield(descriptor+38/*sizeof(WGpuSupportedLimits)+sizeof(WGpuQueueDescriptor)*/)
    };
  },
