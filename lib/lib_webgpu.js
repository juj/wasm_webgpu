...
mergeInto(LibraryManager.library, {
  ...
  wgpu_canvascontext_get_swap_chain_preferred_format__deps: ['wgpuStrings'],
  wgpu_canvascontext_get_swap_chain_preferred_format: function(canvasContext, adapter) {
    {{{ wdebuglog('`wgpu_canvascontext_get_swap_chain_preferred_format: canvasContext: ${canvasContext}, adapter: ${adapter}`'); }}}
