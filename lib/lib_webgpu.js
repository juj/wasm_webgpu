...
//wgpu32BitLimitNames: ['maxTextureDimension1D' (0), 'maxTextureDimension2D' (1), 'maxTextureDimension3D' (2), 'maxTextureArrayLayers' (3), 'maxBindGroups' (4), 'maxBindGroupsPlusVertexBuffers' (5), 'maxBindingsPerBindGroup' (6), 'maxDynamicUniformBuffersPerPipelineLayout' (7), 'maxDynamicStorageBuffersPerPipelineLayout' (8), 'maxSampledTexturesPerShaderStage' (9), 'maxSamplersPerShaderStage' (10), 'maxStorageBuffersPerShaderStage' (11), 'maxStorageBuffersInVertexStage' (12), 'maxStorageBuffersInFragmentStage' (13), 'maxStorageTexturesPerShaderStage' (14), 'maxStorageTexturesInVertexStage' (15), 'maxStorageTexturesInFragmentStage' (16), 'maxUniformBuffersPerShaderStage' (17), 'minUniformBufferOffsetAlignment' (18), 'minStorageBufferOffsetAlignment' (19), 'maxVertexBuffers' (20), 'maxVertexAttributes' (21), 'maxVertexBufferArrayStride' (22), 'maxInterStageShaderVariables' (23), 'maxColorAttachments' (24), 'maxColorAttachmentBytesPerSample' (25), 'maxComputeWorkgroupStorageSize' (26), 'maxComputeInvocationsPerWorkgroup' (27), 'maxComputeWorkgroupSizeX' (28), 'maxComputeWorkgroupSizeY' (29), 'maxComputeWorkgroupSizeZ' (30), 'maxComputeWorkgroupsPerDimension' (31)],
  wgpu32BitLimitNames: "wgpuDecodeStrings('max<:1D?<:2D?<:3D?<ArrayLayers?5s?5sPlus;Buffers?BindingsPer5?Dynamic97?Dynamic=7?Sampled<>?Sampler>?=r>?=rsIn;6?=rsInFrag46?8<>?8<sIn;6?8<sInFrag46?9r> min9rOffsetAlign4 min=rOffsetAlign4?;Buffers?;Attributes?;BufferArrayStride?Inter6ShaderVariables?ColorAttach4s?ColorAttach4BytesPerSample@8Size?ComputeInvocationsPerWorkgroup@SizeX@SizeY@SizeZ@sPer:', ' maxComputeWorkgroup| max|sPerShaderStage|StorageBuffe|Texture|Vertex|Dimension|UniformBuffe|Storage|rsPerPipelineLayout|Stage|BindGroup|ment', 52).slice(1)",
...
//  navigator_gpu_request_adapter_sync__sig: 'ip', // Iirc this would be needed for -sASYNCIFY=1 build mode, but this breaks -sMEMORY64=1 due to the detrimental automatic wrappers
  ...
  wgpu_device_create_texture: function(device, descriptor) {
    ...
    let desc = {
      ...
      'textureBindingViewDimension': HEAPU32[descriptor+11] // Only used in WebGPU compatibility mode, ignored by core devices.
    };
