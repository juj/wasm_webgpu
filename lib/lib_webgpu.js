...
//$GPUTextureAndVertexFormats: [/*undefined*/, 'r8unorm', 'r8snorm', 'r8uint', 'r8sint', 'r16uint', 'r16sint', 'r16float', 'rg8unorm', 'rg8snorm', 'rg8uint', 'rg8sint', 'r32uint', 'r32sint', 'r32float', 'rg16uint', 'rg16sint', 'rg16float', 'rgba8unorm', 'rgba8unorm-srgb', 'rgba8snorm', 'rgba8uint', 'rgba8sint', 'bgra8unorm', 'bgra8unorm-srgb', 'rgb9e5ufloat', 'rgb10a2unorm', 'rg11b10ufloat', 'rg32uint', 'rg32sint', 'rg32float', 'rgba16uint', 'rgba16sint', 'rgba16float', 'rgba32uint', 'rgba32sint', 'rgba32float', 'stencil8', 'depth16unorm', 'depth24plus', 'depth24plus-stencil8', 'depth32float', 'bc1-rgba-unorm', 'bc1-rgba-unorm-srgb', 'bc2-rgba-unorm', 'bc2-rgba-unorm-srgb', 'bc3-rgba-unorm', 'bc3-rgba-unorm-srgb', 'bc4-r-unorm', 'bc4-r-snorm', 'bc5-rg-unorm', 'bc5-rg-snorm', 'bc6h-rgb-ufloat', 'bc6h-rgb-float', 'bc7-rgba-unorm', 'bc7-rgba-unorm-srgb', 'etc2-rgb8unorm', 'etc2-rgb8unorm-srgb', 'etc2-rgb8a1unorm', 'etc2-rgb8a1unorm-srgb', 'etc2-rgba8unorm', 'etc2-rgba8unorm-srgb', 'eac-r11unorm', 'eac-r11snorm', 'eac-rg11unorm', 'eac-rg11snorm', 'astc-4x4-unorm', 'astc-4x4-unorm-srgb', 'astc-5x4-unorm', 'astc-5x4-unorm-srgb', 'astc-5x5-unorm', 'astc-5x5-unorm-srgb', 'astc-6x5-unorm', 'astc-6x5-unorm-srgb', 'astc-6x6-unorm', 'astc-6x6-unorm-srgb', 'astc-8x5-unorm', 'astc-8x5-unorm-srgb', 'astc-8x6-unorm', 'astc-8x6-unorm-srgb', 'astc-8x8-unorm', 'astc-8x8-unorm-srgb', 'astc-10x5-unorm', 'astc-10x5-unorm-srgb', 'astc-10x6-unorm', 'astc-10x6-unorm-srgb', 'astc-10x8-unorm', 'astc-10x8-unorm-srgb', 'astc-10x10-unorm', 'astc-10x10-unorm-srgb', 'astc-12x10-unorm', 'astc-12x10-unorm-srgb', 'astc-12x12-unorm', 'astc-12x12-unorm-srgb', 'depth32float-stencil8', 'uint8x2', 'uint8x4', 'sint8x2', 'sint8x4', 'unorm8x2', 'unorm8x4', 'snorm8x2', 'snorm8x4', 'uint16x2', 'uint16x4', 'sint16x2', 'sint16x4', 'unorm16x2', 'unorm16x4', 'snorm16x2', 'snorm16x4', 'float16x2', 'float16x4', 'float32', 'float32x2', 'float32x3', 'float32x4', 'uint32', 'uint32x2', 'uint32x3', 'uint32x4', 'sint32', 'sint32x2', 'sint32x3', 'sint32x4'],
  $GPUTextureAndVertexFormats: "wgpuDecodeStrings('r8Yr8T r8uW8sWJuWJsWJV B8YB8T B8uWg8sWOuWOsWOV BJuWgJsWgJV U8YU8ZU8T U8uWgba8sint bgra8Ybgra8ZBb9e5uV Bb10a2YB11b10uV BOuWgOsWgOV UJuWgbaJsWgbaJV UOuWgbaOsWgbaOV H KJYK24plus K24plus-H KOV F1-U-YF1-U-ZF2-U-YF2-U-ZF3-U-YF3-U-ZF4-r-YF4-r-T F5-B-YF5-B-T F6h-Bb-uV F6h-Bb-V F7-U-YF7-U-ZQYQZQa1YQa1Zetc2-U8Yetc2-U8ZD11YD11T Dg11YDg11T X4M-YX4M-ZX5M-YX5M-ZX5x5-YX5x5-ZX6x5-YX6x5-ZX6x6-YX6x6-ZX8x5-YX8x5-ZX8x6-YX8x6-ZX8x8-YX8x8-ZXI5-YXI5-ZXI6-YXI6-ZXI8-YXI8-ZXI10-YXI10-ZX12x10-YX12x10-ZX12x12-YX12x12-ZKOV-HP8x2P8MS8x2S8ML8x2L8M T8x2 T8MPJx2PJMSJx2SJMLJx2LJM TJx2 TJM VJx2 VJM VO VOx2 VOx3 VOMPOPOx2POx3POMSOSOx2SOx3SOM', 'unorm-srgb |unorm |astc-|int r|float|rgba|snorm| sint|-AC|etc2-rgb8| uint|32|-B|x4| unorm|depth|16|10x|stencil8|Dgba|bc|MC|eac-r|E |rg|-FMU')",

  wgpu32BitLimitNames__deps: ['$wgpuDecodeStrings'],
//wgpu32BitLimitNames: ['maxTextureDimension1D', 'maxTextureDimension2D', 'maxTextureDimension3D', 'maxTextureArrayLayers', 'maxBindGroups', 'maxDynamicUniformBuffersPerPipelineLayout', 'maxDynamicStorageBuffersPerPipelineLayout', 'maxSampledTexturesPerShaderStage', 'maxSamplersPerShaderStage', 'maxStorageBuffersPerShaderStage', 'maxStorageTexturesPerShaderStage', 'maxUniformBuffersPerShaderStage', 'minUniformBufferOffsetAlignment', 'minStorageBufferOffsetAlignment', 'maxVertexBuffers', 'maxVertexAttributes', 'maxVertexBufferArrayStride', 'maxInterStageShaderComponents', 'maxInterStageShaderVariables', 'maxColorAttachments', 'maxComputeWorkgroupStorageSize', 'maxComputeInvocationsPerWorkgroup', 'maxComputeWorkgroupSizeX', 'maxComputeWorkgroupSizeY', 'maxComputeWorkgroupSizeZ'],
  wgpu32BitLimitNames: "wgpuDecodeStrings('>1D >2D >3D:6ArrayLayers:BindGroups:Dynamic7=Dynamic<=Sampled6@axSampler@ax<;@ax<6@ax7;@in7;8t min<;8t5;s5Attributes5;ArrayStride9Components9Variables:ColorAttachments ?<4:ComputeInvocationsPerWorkgroup ?4X ?4Y ?4Z', 'sPerShaderStage m|maxComputeWorkgroup|maxTextureDimension|BuffersPerPipelineLayout max|Storage|Buffer| max|:InterStageShader|OffsetAlignmen|Uniform|Texture|:Vertex|Size', 52).slice(1)",

  wgpuFeatures__deps: ['$wgpuDecodeStrings'],
//wgpuFeatures: ['depth-clip-control', 'depth32float-stencil8', 'texture-compression-bc', 'texture-compression-etc2', 'texture-compression-astc', 'timestamp-query', 'indirect-first-instance', 'shader-f16', 'bgra8unorm-storage', 'rg11b10ufloat-renderable'],
...
//$GPUBlendFactors: [/*undefined*/, 'zero', 'one', 'src', 'one-minus-src', 'src-alpha', 'one-minus-src-alpha', 'dst', 'one-minus-dst', 'dst-alpha', 'one-minus-dst-alpha', 'src-alpha-saturated', 'constant', 'one-minus-constant'],
