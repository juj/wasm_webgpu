...
//////////////////////////////////////////////////////////////////
  ...
  wgpu_adapter_request_adapter_info_async: function(adapter, unmaskHints, callback, userData) {
    ...
    return wgpu[adapter]['requestAdapterInfo'](hints).then(_wgpuMuteJsExceptions(cb)).catch(
#if ASSERTIONS || global.WEBGPU_DEBUG
  ...
  wgpu_command_encoder_write_timestamp: function(commandEncoder, querySet, queryIndex) {
