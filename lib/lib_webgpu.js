...
//wgpu32BitLimitNames: ['maxTextureDimension1D' (0), 'maxTextureDimension2D' (1), 'maxTextureDimension3D' (2), 'maxTextureArrayLayers' (3), 'maxBindGroups' (4), 'maxBindingsPerBindGroup' (5), 'maxDynamicUniformBuffersPerPipelineLayout' (6), 'maxDynamicStorageBuffersPerPipelineLayout' (7), 'maxSampledTexturesPerShaderStage' (8), 'maxSamplersPerShaderStage' (9), 'maxStorageBuffersPerShaderStage' (10), 'maxStorageTexturesPerShaderStage' (11), 'maxUniformBuffersPerShaderStage' (12), 'minUniformBufferOffsetAlignment' (13), 'minStorageBufferOffsetAlignment' (14), 'maxVertexBuffers' (15), 'maxVertexAttributes' (16), 'maxVertexBufferArrayStride' (17), 'maxInterStageShaderComponents' (18), 'maxInterStageShaderVariables' (19), 'maxColorAttachments' (20), 'maxColorAttachmentBytesPerPixel' (21), 'maxComputeWorkgroupStorageSize' (22), 'maxComputeInvocationsPerWorkgroup' (23), 'maxComputeWorkgroupSizeX' (24), 'maxComputeWorkgroupSizeY' (25), 'maxComputeWorkgroupSizeZ' (26)],
  wgpu32BitLimitNames: "wgpuDecodeStrings('>1D >2D >3D=T4ArrayLay:s=BindGroups=BindingsP:BindGroup=Dynamic<9=DynamicS;69=SampledT4@axSampl:@axS;6@axS;T4@ax<@in<7t minS;67t=V:tex6s=V:texAttributes=V:tex6ArrayStride=Int:StageShad:Components=Int:StageShad:Variables=ColorAttachments=ColorAttachmentBytesP:Pixel ?;Size=ComputeInvocationsP:Workgroup ?izeX ?izeY ?izeZ', 'sPerShaderStage m|maxComputeWorkgroupS|maxTextureDimension| max|UniformBuffer|torage|er|sP:PipelineLayout|7ColorAttachment|OffsetAlignmen|Buff:|7Int:StageShad:|exture', 52).slice(1)",
