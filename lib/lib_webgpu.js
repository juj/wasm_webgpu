...
//////////////////////////////////////////////////////////////////
  ...
  $wgpuReadRenderPipelineDescriptor: function(descriptor) {
    ...
    let vertexBuffers = [],
        ...
        numVertexBuffers = HEAP32[vertexIdx+2], // +2 == WGpuVertexState.numBuffers
        vertexBuffersIdx = {{{ shiftPtr('HEAPU32[vertexIdx+3]', 2) }}}, // +3 == WGpuVertexState.buffers
        primitiveIdx = vertexIdx + 6, // sizeof(WGpuVertexState)
        depthStencilIdx = primitiveIdx + 5, // sizeof(WGpuPrimitiveState)
        multisampleIdx = depthStencilIdx + 17, // sizeof(WGpuDepthStencilState)
        fragmentIdx = multisampleIdx + 3, // sizeof(WGpuMultisampleState)
        numTargets = HEAP32[fragmentIdx+2], // +2 == WGpuFragmentState.numTargets
        targetsIdx = {{{ shiftPtr('HEAPU32[fragmentIdx+3]', 2) }}}, // +3 == WGpuFragmentState.targets
        depthStencilFormat = HEAPU32[depthStencilIdx],
        multisampleCount = HEAPU32[multisampleIdx],
        fragmentModule = HEAPU32[fragmentIdx],
        pipelineLayoutId = HEAPU32[fragmentIdx+6], // sizeof(WGpuFragmentState)
        desc;
