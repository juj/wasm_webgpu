...
//wgpuFeatures: ['depth-clip-control' (0), 'depth32float-stencil8' (1), 'texture-compression-bc' (2), 'texture-compression-bc-sliced-3d' (3), 'texture-compression-etc2' (4), 'texture-compression-astc' (5), 'texture-compression-astc-sliced-3d' (6), 'timestamp-query' (7), 'indirect-first-instance' (8), 'shader-f16' (9), 'rg11b10ufloat-renderable' (10), 'bgra8unorm-storage' (11), 'float32-filterable' (12), 'float32-blendable' (13), 'clip-distances' (14), 'dual-source-blending' (15), 'subgroups' (16), 'texture-formats-tier1' (17)],
  wgpuFeatures: "wgpuDecodeStrings('D-Econtrol D32J-Fencil8KbcKbIKetc2KaFcKaFI timeFamp-quCy indirectAirF-inB shadCA16 rg11b10uJ-rendCHbgra8unorm-Forage J32AiltCHJ32GHEdiBs dual-sourceGing subgroups textureAormats-tiC1', ' texture-compression-|float|c-sliced-3d|able |-blend|st|clip-|depth|er|Fance|-f').slice(1)",
