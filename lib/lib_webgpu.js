...
//wgpuFeatures: ['depth-clip-control' (0), 'depth32float-stencil8' (1), 'texture-compression-bc' (2), 'texture-compression-bc-sliced-3d' (3), 'texture-compression-etc2' (4), 'texture-compression-astc' (5), 'timestamp-query' (6), 'indirect-first-instance' (7), 'shader-f16' (8), 'rg11b10ufloat-renderable' (9), 'bgra8unorm-storage' (10), 'float32-filterable' (11), 'clip-distances' (12), 'dual-source-blending' (13), 'subgroups' (14)],
  wgpuFeatures: "wgpuDecodeStrings('C-Bcontrol C32E-Dencil8GbcGbc-sliced-3dGetc2GaDc timeDamp-query indirect-firD-inA shader-f16 rg11b10uE-rendFbgra8unorm-Dorage E32-filtFBdiAs dual-source-blending subgroups', ' texture-compression-|erable |float|st|depth|clip-|Dance').slice(1)",
