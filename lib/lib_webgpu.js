...
//////////////////////////////////////////////////////////////////
  ...
  wgpu_adapter_or_device_get_limits: function(adapterOrDevice, limits) {
    ...
    {{{ ptrToIdx('limits', 2); }}}
    wgpuWriteU64HeapIdx(limits, l['maxUniformBufferBindingSize']);
    wgpuWriteU64HeapIdx(limits+2, l['maxStorageBufferBindingSize']);
    limits += 4;
  ...
  wgpu_adapter_request_device_async: function(adapter, descriptor, deviceCallback, userData) {
    ...
    // Marshal all the complex 64-bit quantities manually ..
    if (v = wgpuReadI53FromU64HeapIdx(descriptor+2)) requiredLimits['maxUniformBufferBindingSize'] = v;
    if (v = wgpuReadI53FromU64HeapIdx(descriptor+4)) requiredLimits['maxStorageBufferBindingSize'] = v;
    descriptor += 6;

    // .. but the 32-bit quantities in a common loop.
    for(let limitName of _wgpu32BitLimitNames) {
