...
let api = {
  ...
  wgpu_destroy_all_objects: function() {
    Object.values(wgpu).forEach(o => { if (o['destroy']) o['destroy'](); });
    wgpu = {};
  },
...
//////////////////////////////////////////////////////////////////
  ...
  $wgpuStoreAsyncifiedOp__deps: ['_wgpuNumAsyncifiedOperationsPending', '$wgpuStoreAndSetParent'],
  $wgpuStoreAsyncifiedOp: function(object, parent) {
    {{{ wassert('__wgpuNumAsyncifiedOperationsPending > 0'); }}}
    --__wgpuNumAsyncifiedOperationsPending;
    return wgpuStoreAndSetParent(object, parent);
  },
