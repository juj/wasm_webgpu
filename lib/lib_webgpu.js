...
// wgpuFeatures: 'depth-clip-control depth24unorm-stencil8 depth32float-stencil8 texture-compression-bc texture-compression-etc2 texture-compression-astc timestamp-query indirect-first-instance shader-f16'.split(' '),
  wgpuFeatures__deps: ['$wgpuDecodeStrings'],
  wgpuFeatures: "wgpuDecodeStrings('C-clip-control C24unormB C32floatBDbcDetc2DaAc timeAamp-query indirect-firA-inAance shader-f16',' texture-compression-|depth|-stencil8|st').slice(1)",
