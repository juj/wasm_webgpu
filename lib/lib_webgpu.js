...
mergeInto(LibraryManager.library, {
  ...
  wgpuFeatures: 'depth-clip-control depth32float-stencil8 texture-compression-bc texture-compression-etc2 texture-compression-astc timestamp-query indirect-first-instance shader-f16'.split(' '),
