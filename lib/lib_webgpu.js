...
//  $GPUTextureSampleTypes: [, 'float', 'unfilterable-float', 'depth', 'sint', 'uint'],
  ...
  $wgpuReadArrayOfWgpuObjects: function(ptr, numObjects) {
    ...
    var arrayOfObjects = [];
    while(numObjects--) {
      {{{ wassert('HEAPU32[arrayOfObjects]'); }}} // Must reference a nonzero WebGPU object handle
      {{{ wassert('wgpu[HEAPU32[arrayOfObjects]]'); }}} // Must reference a valid WebGPU object
      e.push(wgpu[HEAPU32[ptr++]]);
    }
