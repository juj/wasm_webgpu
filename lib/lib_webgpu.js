...
//wgpuFeatures: ['depth-clip-control' (0), 'depth32float-stencil8' (1), 'texture-compression-bc' (2), 'texture-compression-bc-sliced-3d' (3), 'texture-compression-etc2' (4), 'texture-compression-astc' (5), 'timestamp-query' (6), 'indirect-first-instance' (7), 'shader-f16' (8), 'rg11b10ufloat-renderable' (9), 'bgra8unorm-storage' (10), 'float32-filterable' (11), 'clip-distances' (12), 'dual-source-blending' (13), 'subgroups' (14), 'texture-formats-tier1' (15)],
  wgpuFeatures: "wgpuDecodeStrings('B-Ccontrol B32G-Dencil8HbcHbc-sliced-3dHetc2HaDc timeDamp-query indirectAirD-inE shaderA16 rg11b10uG-rendFbgra8unorm-Dorage G32AiltFCdiEs dual-source-blending subgroups textureAormats-tier1', ' texture-compression-|float|erable |stance|st|clip-|depth|-f').slice(1)",
