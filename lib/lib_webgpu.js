...
//wgpuFeatures: ['depth-clip-control' (0), 'depth32float-stencil8' (1), 'texture-compression-bc' (2), 'texture-compression-bc-sliced-3d' (3), 'texture-compression-etc2' (4), 'texture-compression-astc' (5), 'timestamp-query' (6), 'indirect-first-instance' (7), 'shader-f16' (8), 'rg11b10ufloat-renderable' (9), 'bgra8unorm-storage' (10), 'float32-filterable' (11), 'float32-blendable' (12), 'clip-distances' (13), 'dual-source-blending' (14), 'subgroups' (15), 'texture-formats-tier1' (16)],
  wgpuFeatures: "wgpuDecodeStrings('B-Econtrol B32I-Fencil8JbcJbc-sliced-3dJetc2JaFc timeFamp-quCy indirectAirF-inG shadCA16 rg11b10uI-rendCHbgra8unorm-Forage I32AiltCHI32DHEdiGs dual-sourceDing subgroups textureAormats-tiC1', ' texture-compression-|float|able |stance|st|clip-|-blend|er|depth|-f').slice(1)",
