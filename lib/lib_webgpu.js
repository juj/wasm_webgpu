...
{{{
  ...
  globalThis.readPtr = function(ptr) {
    if (MEMORY64) return `HEAPU64[${ptr}]`;
    else          return `HEAPU32[${ptr}]`;
  }
  null;
}}}
...
//////////////////////////////////////////////////////////////////
  ...
  wgpu_canvas_context_configure: function(canvasContext, config) {
    ...
    let desc = {
      ...
      'viewFormats': wgpuReadArrayOfWgpuObjects({{{readPtr('config+4')}}}, HEAPU32[config+3]), // TODO: Wasm64
  ...
  $wgpuReadShaderModuleCompilationHints: function(index) {
    ...
    while(numHints--) {
      ...
      hints.push({
        'entryPoint': utf8(HEAPU32[hintsIndex]), // TODO: Wasm64
  ...
  $wgpuReadRenderPipelineDescriptor: function(descriptor) {
    ...
    desc = {
      'vertex': {
        ...
        'entryPoint': utf8(HEAPU32[vertexIdx]) || void 0, // TODO: Wasm64
      ...
      'fragment': fragmentModule ? {
        ...
        // If null pointer was passed to use the default entry point name, then utf8() would return '', but spec requires undefined.
        'entryPoint': utf8(HEAPU32[fragmentIdx]) || void 0, // TODO: Wasm64
        'targets': targets,
  ...
  $wgpuReadConstants: function(constants, numConstants) {
    ...
    let c = {};
    while(numConstants--) {
      c[utf8(HEAPU32[{{{ shiftPtr('constants', 2) }}}])] = HEAPF64[{{{ shiftPtr('constants + 8', 3) }}}]; // TODO Wasm64
      constants += 16;
    }
    return c;
  },
