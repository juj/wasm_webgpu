...
//////////////////////////////////////////////////////////////////
  ...
  wgpu_canvas_context_configure: function(canvasContext, config) {
    ...
    let desc = {
      ...
      'toneMapping': {
        'mode': [, 'standard', 'extended'][HEAPU32[config+6]]
      },
      'alphaMode': [, 'opaque', 'premultiplied'][HEAPU32[config+7]]
    };
  ...
  $wgpuReadDeviceDescriptor: function(descriptor) {
    ...
    return {
      'requiredFeatures': wgpuReadFeaturesBitfield(descriptor/*sizeof(WGpuSupportedLimits)+sizeof(WGpuQueueDescriptor)*/),
      'requiredLimits': wgpuReadSupportedLimits(descriptor+2/*sizeof(WGPU_FEATURES_BITFIELD)+sizeof(unused_padding)*/),
      'defaultQueue': wgpuReadQueueDescriptor(descriptor+38/*sizeof(WGPU_FEATURES_BITFIELD)+sizeof(unused_padding)+sizeof(WGpuSupportedLimits)*/),
    };
  },
