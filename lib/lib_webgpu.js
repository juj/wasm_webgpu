...
mergeInto(LibraryManager.library, {
  ...
  $wgpuStore: function(object) {
    if (object) {
      // XXX delete this once Chrome is up to date with spec:
      if (object.endPass && !object.end) object.end = object.endPass;
      // XXX delete above once Chrome is up to date with spec
...
//  $GPUTextureSampleTypes: [, 'float', 'unfilterable-float', 'depth', 'sint', 'uint'],
  ...
  wgpu_canvas_context_configure__deps: ['$GPUTextureAndVertexFormats', '$GPUPredefinedColorSpaces', '$wgpuReadArrayOfWgpuObjects'],
