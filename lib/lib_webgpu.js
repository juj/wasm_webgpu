...
//wgpu32BitLimitNames: ['maxTextureDimension1D' (0), 'maxTextureDimension2D' (1), 'maxTextureDimension3D' (2), 'maxTextureArrayLayers' (3), 'maxBindGroups' (4), 'maxDynamicUniformBuffersPerPipelineLayout' (5), 'maxDynamicStorageBuffersPerPipelineLayout' (6), 'maxSampledTexturesPerShaderStage' (7), 'maxSamplersPerShaderStage' (8), 'maxStorageBuffersPerShaderStage' (9), 'maxStorageTexturesPerShaderStage' (10), 'maxUniformBuffersPerShaderStage' (11), 'minUniformBufferOffsetAlignment' (12), 'minStorageBufferOffsetAlignment' (13), 'maxVertexBuffers' (14), 'maxVertexAttributes' (15), 'maxVertexBufferArrayStride' (16), 'maxInterStageShaderComponents' (17), 'maxInterStageShaderVariables' (18), 'maxColorAttachments' (19), 'maxColorAttachmentBytesPerPixel' (20), 'maxComputeWorkgroupStorageSize' (21), 'maxComputeInvocationsPerWorkgroup' (22), 'maxComputeWorkgroupSizeX' (23), 'maxComputeWorkgroupSizeY' (24), 'maxComputeWorkgroupSizeZ' (25)],
  wgpu32BitLimitNames: "wgpuDecodeStrings('>1D >2D >3D max4eArrayLayer<BindGroup<Dynamic6=DynamicS:=Sampled4es@axSamplers@axS:;s@axS:4es@ax6;s@in6;OffsetAlignment minS:;OffsetAlignment max5;<5Attribute<5;ArrayStride max8Component<8Variable<7<7BytesPerPixel?:Size maxComputeInvocationsPerWorkgroup?izeX?izeY?izeZ', 'PerShaderStage m| maxComputeWorkgroupS|maxTextureDimension|BuffersPerPipelineLayout max|s max|Buffer|torage|9OffsetAlignment|InterStageShader|ColorAttachment|Uniform|Vertex|Textur', 52).slice(1)",
