{{{ (function() { global.wassert = function(condition) { return ASSERTIONS || global.WEBGPU_DEBUG ? `assert(${condition});` : ''; }; return null; })(); }}}
...
mergeInto(LibraryManager.library, {
  ...
  $wgpuStoreAndSetParent: function(object, parent) {
    ...
    parent.derivedObjects.push(object);
    return object;
  },
  ...
  wgpu_canvas_get_webgpu_context: function(canvasSelector) {
    ...
    {{{ wdebuglog('`canvas.getContext("webgpu")`'); }}}
    {{{ wdebugdir('context'); }}}
    return wgpuStore(context);
#else
    // Minify manually since Closure is unable to do it.
    return wgpuStore(document.querySelector(UTF8ToString(canvasSelector)).getContext('webgpu'));
#endif
  },
  ...
  // $GPUTextureAndVertexFormats: 'r8unorm r8snorm r8uint r8sint r16uint r16sint r16float rg8unorm rg8snorm rg8uint rg8sint r32uint r32sint r32float rg16uint rg16sint rg16float rgba8unorm rgba8unorm-srgb rgba8snorm rgba8uint rgba8sint bgra8unorm bgra8unorm-srgb rgb9e5ufloat rgb10a2unorm rg11b10ufloat rg32uint rg32sint rg32float rgba16uint rgba16sint rgba16float rgba32uint rgba32sint rgba32float stencil8 depth16unorm depth24plus depth24plus-stencil8 depth32float bc1-rgba-unorm bc1-rgba-unorm-srgb bc2-rgba-unorm bc2-rgba-unorm-srgb bc3-rgba-unorm bc3-rgba-unorm-srgb bc4-r-unorm bc4-r-snorm bc5-rg-unorm bc5-rg-snorm bc6h-rgb-ufloat bc6h-rgb-float bc7-rgba-unorm bc7-rgba-unorm-srgb etc2-rgb8unorm etc2-rgb8unorm-srgb etc2-rgb8a1unorm etc2-rgb8a1unorm-srgb etc2-rgba8unorm etc2-rgba8unorm-srgb eac-r11unorm eac-r11snorm eac-rg11unorm eac-rg11snorm astc-4x4-unorm astc-4x4-unorm-srgb astc-5x4-unorm astc-5x4-unorm-srgb astc-5x5-unorm astc-5x5-unorm-srgb astc-6x5-unorm astc-6x5-unorm-srgb astc-6x6-unorm astc-6x6-unorm-srgb astc-8x5-unorm astc-8x5-unorm-srgb astc-8x6-unorm astc-8x6-unorm-srgb astc-8x8-unorm astc-8x8-unorm-srgb astc-10x5-unorm astc-10x5-unorm-srgb astc-10x6-unorm astc-10x6-unorm-srgb astc-10x8-unorm astc-10x8-unorm-srgb astc-10x10-unorm astc-10x10-unorm-srgb astc-12x10-unorm astc-12x10-unorm-srgb astc-12x12-unorm astc-12x12-unorm-srgb depth24unorm-stencil8 depth32float-stencil8 uint8x2 uint8x4 sint8x2 sint8x4 unorm8x2 unorm8x4 snorm8x2 snorm8x4 uint16x2 uint16x4 sint16x2 sint16x4 unorm16x2 unorm16x4 snorm16x2 snorm16x4 float16x2 float16x4 float32 float32x2 float32x3 float32x4 uint32 uint32x2 uint32x3 uint32x4 sint32 sint32x2 sint32x3 sint32x4'.split(' '),
  $GPUTextureAndVertexFormats__deps: ['$wgpuDecodeStrings'],
  $GPUTextureAndVertexFormats: "wgpuDecodeStrings('r8W r8S r8uU r8sU rIuU rIsU rIVO8WO8SO8uUO8sU rLuU rLsU rLVOIuUOIsUOIV T8W T8WX T8S T8uU T8sU bgra8W bgra8WXOb9e5uVOb10a2WO11b10uVOLuUOLsUOLV TIuU TIsU TIV TLuU TLsU TLV JRIWR24plusR24plus-JRLVQ1-TZQ1-TZXQ2-TZQ2-TZXQ3-TZQ3-TZXQ4-rZQ4-r-SQ5-rgZQ5-rg-SQ6h-A-uVQ6h-A-VQ7-TZQ7-TZXPA8WPA8WXPA8a1WPA8a1WXPT8WPT8WXF11WF11SFg11WFg11SY4x4ZY4x4ZXY5x4ZY5x4ZXY5x5ZY5x5ZXY6x5ZY6x5ZXY6x6ZY6x6ZXY8x5ZY8x5ZXY8x6ZY8x6ZXY8x8ZY8x8ZXYB5ZYB5ZXYB6ZYB6ZXYB8ZYB8ZXYB10ZYB10ZXY12x10ZY12x10ZXY12x12ZY12x12ZXR24W-JRLV-J uU8NuU8KsU8NsU8KW8NW8KS8NS8KuUINuUIKsUINsUIKWINWIKSINSIKVINVIKVL VLNVLx3 VLKuUL uULNuULx3 uULKsUL sULNsULx3 sULx4','-unorm| astc-|-srgb|unorm|float|int|rgba|snorm| depth| bc| etc2-| rg|x2 |ACB|32|x4 |stencil8|16|sF|-GA| eac-r|AB|uF| G|10x|rgb')",

// wgpuFeatures: 'depth-clamping depth24unorm-stencil8 depth32float-stencil8 pipeline-statistics-query texture-compression-bc texture-compression-etc2 texture-compression-astc timestamp-query'.split(' '),
  wgpuFeatures__deps: ['$wgpuDecodeStrings'],
  wgpuFeatures: "wgpuDecodeStrings('F-clamping F24unorm-EF32float-Epipeline-AatiAicsDHCGbcHCGetc2HCGaAc timeAampD',' texture-|pression-|depth|stencil8 |-query|com|AFB|st').slice(1)",

//  wgpu32BitLimitNames: ['maxTextureDimension1D', 'maxTextureDimension2D', 'maxTextureDimension3D', 'maxTextureArrayLayers', 'maxBindGroups', 'maxDynamicUniformBuffersPerPipelineLayout', 'maxDynamicStorageBuffersPerPipelineLayout', 'maxSampledTexturesPerShaderStage', 'maxSamplersPerShaderStage', 'maxStorageBuffersPerShaderStage', 'maxStorageTexturesPerShaderStage', 'maxUniformBuffersPerShaderStage', 'minUniformBufferOffsetAlignment', 'minStorageBufferOffsetAlignment', 'maxVertexBuffers', 'maxVertexAttributes', 'maxVertexBufferArrayStride', 'maxInterStageShaderComponents', 'maxComputeWorkgroupStorageSize', 'maxComputeInvocationsPerWorkgroup', 'maxComputeWorkgroupSizeX', 'maxComputeWorkgroupSizeY', 'maxComputeWorkgroupSizeZ'],
  //wgpu32BitLimitNames: "'maxTextureDimension1D maxTextureDimension2D maxTextureDimension3D maxTextureArrayLayers maxBindGroups maxDynamicUniformBuffersPerPipelineLayout maxDynamicStorageBuffersPerPipelineLayout maxSampledTexturesPerShaderStage maxSamplersPerShaderStage maxStorageBuffersPerShaderStage maxStorageTexturesPerShaderStage maxUniformBuffersPerShaderStage minUniformBufferOffsetAlignment minStorageBufferOffsetAlignment maxVertexBuffers maxVertexAttributes maxVertexBufferArrayStride maxInterStageShaderComponents maxComputeWorkgroupStorageSize maxComputeInvocationsPerWorkgroup maxComputeWorkgroupSizeX maxComputeWorkgroupSizeY maxComputeWorkgroupSizeZ'.split(' ')",
  wgpu32BitLimitNames__deps: ['$wgpuDecodeStrings'],
  wgpu32BitLimitNames: "wgpuDecodeStrings(';n1D ;n2D ;n3D 96ArrayLayers 9BindGroups 9Dynamic4<8Dynamic:<8Sampled6>9Sampler>9:<>9:6>94<>min4<7min:<75<s 5Attributes 5<ArrayStride 9InterStageShaderComponents=p:Size 9ComputeInvocationsPerWorkgroup=pSizeX=pSizeY=pSizeZ','sPerShaderStage | maxComputeWorkgrou|Buffer|maxTextureDimensio|Storage|max|sPerPipelineLayout 9|OffsetAlignment |Texture|9Vertex|Uniform',52).slice(1)",

  //$GPUCompareFunctions: [, 'never', 'less', 'equal', 'less-equal', 'greater', 'not-equal', 'greater-equal', 'always'],
  $GPUCompareFunctions: "wgpuDecodeStrings('neverA CA-CB not-CB-C always','equal| greater| less')",
...
//  $GPUBlendFactors: [, 'zero', 'one', 'src', 'one-minus-src', 'src-alpha', 'one-minus-src-alpha', 'dst', 'one-minus-dst', 'dst-alpha', 'one-minus-dst-alpha', 'src-alpha-saturated', 'constant', 'one-minus-constant'],
  $GPUBlendFactors: "wgpuDecodeStrings('zero one AEA ADEAD CEC CDECD AD-saturated BEB',' one-minus-|-alpha|dst|constant|src')",
...
//  $GPUTextureViewDimensions: [, '1d', '2d', '2d-array', 'cube', 'cube-array', '3d'],
  $GPUTextureViewDimensions: "wgpuDecodeStrings('1B 2dCAAC 3d','-array|d 2d| cube')",
...
//  $GPUPipelineStatisticNames: [, 'vertex-shader-invocations', 'clipper-invocations', 'clipper-primitives-out', 'fragment-shader-invocations', 'compute-shader-invocations'],
  $GPUPipelineStatisticNames: "wgpuDecodeStrings('vertexBCACAer-primitives-out fragmentBC computeBC','er-invocations|-shad| clipp')",
...
//  $GPUTextureSampleTypes: [, 'float', 'unfilterable-float', 'depth', 'sint', 'uint'],
  ...
  $GPUPredefinedColorSpaces: [, 'srgb'],
  $GPUFilterModes: [, 'nearest', 'linear'],
  $GPULoadOps: [, 'load'],
  $GPUStoreOps: [, 'store', 'discard'],

  wgpu_canvas_context_get_preferred_format__deps: ['$GPUTextureAndVertexFormats'],
  wgpu_canvas_context_get_preferred_format: function(canvasContext, adapter) {
    {{{ wdebuglog('`wgpu_canvas_context_get_preferred_format: canvasContext: ${canvasContext}, adapter: ${adapter}`'); }}}
    {{{ wassert('wgpu[canvasContext] instanceof GPUCanvasContext'); }}}
    {{{ wassert('wgpu[adapter] instanceof GPUAdapter'); }}}

    {{{ wassert('GPUTextureAndVertexFormats.includes(wgpu[canvasContext].getPreferredFormat(wgpu[adapter]))'); }}}
    return GPUTextureAndVertexFormats.indexOf(wgpu[canvasContext]['getPreferredFormat'](wgpu[adapter]));
  },

  wgpu_canvas_context_configure__deps: ['$GPUTextureAndVertexFormats', '$GPUPredefinedColorSpaces'],
  wgpu_canvas_context_configure: function(canvasContext, config) {
    ...
    {{{ ptrToIdx('config', 2); }}}
      ...
      'colorSpace': GPUPredefinedColorSpaces[HEAPU32[config+3]],
      'compositingAlphaMode': [, 'opaque', 'premultiplied'][HEAPU32[config+4]],
      'size': HEAP32[config+5] ? [HEAP32[config+5], HEAP32[config+6], HEAP32[config+7]] : void 0
    };
    {{{ wdebuglog('`calling canvasContext.configure() with config:`'); }}}
    {{{ wdebugdir('desc'); }}}
    wgpu[canvasContext]['configure'](desc);
#else
    // Manually minify since Closure is unable to do it.
  ...
  wgpu_canvas_context_get_current_texture: function(c) {
    {{{ wdebuglog('`wgpu_canvas_context_get_current_texture(canvasContext=${c})`'); }}}
    {{{ wassert('wgpu[c] instanceof GPUCanvasContext'); }}}
    ...
    {{{ wassert('!c.derivedObjects || c.derivedObjects.length < 1000'); }}}
    if (c != wgpu[1]) {
      // ... and destroy previous special canvas context texture, if it was an old one.
      _wgpu_object_destroy(1);
      wgpu[1] = c;
      c.wid = 1;
      c.derivedObjects = []; // GPUTextureViews are derived off of GPUTextures
    }
  ...
  wgpu_device_set_lost_callback: function(device, callback, userData) {
    ...
    wgpu[device]['lost'].then((deviceLostInfo) => {
      var reason = deviceLostInfo['reason'] == 'destroyed' ? 1/*WGPU_DEVICE_LOST_REASON_DESTROYED*/ : 0;
  ...
  wgpu_device_push_error_scope: function(device, filter) {
    {{{ wassert('wgpu[device] instanceof GPUDevice'); }}}
    wgpu[device]['pushErrorScope']([, 'out-of-memory', 'validation'][filter]);
  },
  ...
  wgpuDispatchWebGpuErrorEvent: function(device, callback, error, userData) {
    // Awkward WebGPU spec: errors do not contain any kind of general string and/or
    // error code that could be used to marshal info over in a general forward
    // compatible fashion, but must look at the types of the errors. (if new errors
    // are introduced in the future, those won't be recognized)
    var errorCode = error ? (error instanceof GPUValidationError
      ? 2/*WGPU_ERROR_FILTER_VALIDATION*/
      : (error instanceof GPUOutOfMemoryError ? 1/*WGPU_ERROR_FILTER_OUT_OF_MEMORY*/ : -1)) : 0 /*no error*/;
  ...
  navigator_gpu_request_adapter_async__deps: ['$wgpuStore'],
  navigator_gpu_request_adapter_async: function(options, adapterCallback, userData) {
    ...
    if (gpu) {
      ...
      var powerPreference = [, 'low-power', 'high-performance'][HEAPU32[options]],
        opts = {};
      ...
      gpu['requestAdapter'](opts).then(cb).catch(cb);
      return 1/*EM_TRUE*/;
    }
  ...
  wgpu_adapter_or_device_get_limits__deps: ['wgpu32BitLimitNames'],
  wgpu_adapter_or_device_get_limits: function(adapterOrDevice, limits) {
    ...
    {{{ ptrToIdx('limits', 2); }}}
    for(var limitName of _wgpu32BitLimitNames) {
      HEAPU32[limits++] = wgpu[adapterOrDevice]['limits'][limitName];
    }
  },
  ...
  wgpu_adapter_request_device_async__deps: ['$wgpuStore', 'wgpuFeatures', 'wgpu32BitLimitNames', '$wgpuReadI53FromU64HeapIdx'],
  wgpu_adapter_request_device_async: function(adapter, descriptor, deviceCallback, userData) {
    ...
    {{{ wassert('_wgpuFeatures.length == 6'); }}}

    for(var i = 0; i < 6/*_wgpuFeatures.length*/; ++i) {
      if (v & (1 << i)) requiredFeatures.push(_wgpuFeatures[i]);
    }
    ++descriptor;

    // Marshal all the 32-bit quantities in a common loop ..
    for(var limitName of _wgpu32BitLimitNames) {
      if ((v = HEAPU32[descriptor++])) requiredLimits[limitName] = v;
    }
    // .. but the complex 64-bit quantities manually.
    if (v = wgpuReadI53FromU64HeapIdx(descriptor+1)) requiredLimits['maxUniformBufferBindingSize'] = v;
    if (v = wgpuReadI53FromU64HeapIdx(descriptor+3)) requiredLimits['maxStorageBufferBindingSize'] = v;
    ...
    wgpu[adapter]['requestDevice'](descriptor).then(cb).catch(cb);
#else
    // Manually minify since Closure is unable to do it.
  ...
  wgpu_device_create_shader_module: function(device, descriptor) {
    ...
    {{{ wassert('descriptor % 4 == 0'); }}} // Must be aligned at uint32_t boundary
    device = wgpu[device];
    var code = UTF8ToString(HEAPU32[{{{ shiftPtr('descriptor', 2) }}}]);
...
#else
    // Manually minify the code since Closure is unable to do it
    return wgpuStoreAndSetParent(wgpu[device]['createShaderModule']({ 'code': UTF8ToString(HEAPU32[{{{ shiftPtr('descriptor', 2) }}}]) }), wgpu[device]);
#endif
  },
  ...
  $wgpuReadRenderPipelineDescriptor__deps: ['$readI53FromU64', '$wgpuReadGpuStencilFaceState', '$wgpuReadGpuBlendComponent', '$wgpuReadI53FromU64HeapIdx', '$wgpuReadConstants', '$GPUIndexFormats', '$GPUTextureAndVertexFormats', '$GPUCompareFunctions', '$GPUPrimitiveTopologys'],
  $wgpuReadRenderPipelineDescriptor: function(descriptor) {
    ...
    var vertexBuffers = [],
        ...
        depthStencilIdx = primitiveIdx + 4,
    ...
    desc = {
      ...
      'layout': wgpu[HEAPU32[fragmentIdx+6]]
    };
...
#else
    // Manually minify since Closure is unable to do it.
    return wgpuStoreAndSetParent(wgpu[device]['createRenderPipeline'](wgpuReadRenderPipelineDescriptor(descriptor)), wgpu[device]);
#endif
  },
  ...
  wgpu_device_create_render_pipeline_async: function(device, descriptor, callback, userData) { // TODO: this function is untested. Write a test case
    ...
    {{{ wdebugdir('desc'); }}}
    wgpu[device]['createRenderPipelineAsync'](desc).then((pipeline) => {
      {{{ wdebuglog('`createRenderPipelineAsync completed with pipeline:`'); }}}
      {{{ wdebugdir('pipeline'); }}}
      {{{ makeDynCall('viii', 'callback') }}}(device, wgpuStoreAndSetParent(pipeline, wgpu[device]), userData);
    });
#else
    // Manually minify since Closure is unable to do it.
    wgpu[device]['createRenderPipelineAsync'](wgpuReadRenderPipelineDescriptor(descriptor)).then((pipeline) => {
      {{{ makeDynCall('viii', 'callback') }}}(device, wgpuStoreAndSetParent(pipeline, wgpu[device]), userData);
    });
#endif
  },
...
#if ASSERTIONS
    var desc = descriptor ? {
      'measureExecutionTime': !!HEAPU32[{{{ shiftPtr('descriptor', 2) }}}]
    } : void 0;
...
#else
    // Manually minify since Closure is unable to do it
    return wgpuStoreAndSetParent(wgpu[device]['createCommandEncoder'](descriptor ? {
        'measureExecutionTime': !!HEAPU32[{{{ shiftPtr('descriptor', 2) }}}]
      } : void 0), wgpu[device]);
#endif
  },
  ...
  wgpu_device_create_render_bundle_encoder__deps: ['$GPUTextureFormat', '$wgpuStoreAndSetParent'],
  wgpu_device_create_render_bundle_encoder: function(device, descriptor) { // TODO: this function is untested. Write a test case
    ...
    var colorFormatsIdx = {{{ shiftPtr('HEAPU32[descriptor+1]', 2) }}};
    while(numColorFormats--) {
      colorFormats.push(GPUTextureFormat[HEAPU32[colorFormatsIdx++]]);
    }

#if ASSERTIONS
    var desc = {
      'colorFormats': colorFormats,
      'depthStencilFormat': GPUTextureFormat[HEAPU32[descriptor+2]],
...
#else
    // Manually minify since Closure is unable to do it.
    return wgpuStoreAndSetParent(device['createRenderBundleEncoder']({
        'colorFormats': colorFormats,
        'depthStencilFormat': GPUTextureFormat[HEAPU32[descriptor+2]],
        'sampleCount': HEAPU32[descriptor+3]
      }), device);
  ...
  wgpu_device_create_query_set__deps: ['$GPUPipelineStatisticNames', '$wgpuStoreAndSetParent'],
  wgpu_device_create_query_set: function(device, descriptor) { // TODO: this function is untested. Write a test case
    ...
    var pipelineStatisticsIdx = {{{ shiftPtr('HEAPU32[descriptor+3]', 2) }}};
...
#if ASSERTIONS
    var desc = {
      'type': [, 'occlusion', 'pipeline-statistics', 'timestamp'][HEAPU32[descriptor]],
...
#else
    // Manually minify since Closure is unable to do it.
    return wgpuStoreAndSetParent(device['createQuerySet']({
        'type': [, 'occlusion', 'pipeline-statistics', 'timestamp'][HEAPU32[descriptor]],
        'count': HEAPU32[descriptor+1],
        'pipelineStatistics': pipelineStatistics
      }), device);
  ...
  wgpu_device_create_texture__deps: ['$wgpuStoreAndSetParent', '$GPUTextureAndVertexFormats'],
  ...
  wgpu_device_create_bind_group_layout__deps: ['$wgpuStoreAndSetParent', '$GPUBufferBindingTypes', '$GPUSamplerBindingTypes', '$GPUTextureSampleTypes', '$GPUTextureViewDimensions', '$GPUTextureAndVertexFormats'],
...
#else
    // Manually minify code since Closure is unable to do it.
    return wgpuStoreAndSetParent(device['createPipelineLayout']({
        'bindGroupLayouts': e
      }), device);
#endif
  },
...
#else
    // Manually minify since Closure is unable to do it
    return wgpuStoreAndSetParent(device['createBindGroup']({
        'layout': wgpu[layout],
        'entries': e
      }), device);
#endif
  ...
  wgpu_device_create_compute_pipeline__deps: ['$wgpuStoreAndSetParent', '$wgpuReadConstants'],
  wgpu_device_create_compute_pipeline: function(device, computeModule, entryPoint, constants, numConstants) { // TODO: this function is untested. Write a test case
...
#else
    // Manually minify since Closure is unable to do it
    return wgpuStoreAndSetParent(device['createComputePipeline']({
        'compute': {
          'module': wgpu[computeModule],
          'entryPoint': UTF8ToString(entryPoint),
          'constants': wgpuReadConstants(constants, numConstants)
...
#else
    // Manually minify since Closure is unable to do it.
    return wgpuStoreAndSetParent(wgpu[texture]['createView'](descriptor ? {
        'format': GPUTextureAndVertexFormats[HEAPU32[descriptor]],
        'dimension': GPUTextureViewDimensions[HEAPU32[descriptor+1]],
        'aspect': GPUTextureAspects[HEAPU32[descriptor+2]],
        'baseMipLevel': HEAP32[descriptor+3],
  ...
  wgpu_command_encoder_begin_render_pass__deps: ['$GPULoadOps', '$GPUStoreOps'],
  wgpu_command_encoder_begin_render_pass: function(commandEncoder, descriptor) {
    ...
    while(numColorAttachments--) {
      colorAttachments.push({
        ...
        'loadValue': GPULoadOps[HEAPU32[colorAttachmentsIdx+3]] ||
    ...
    descriptor = {
      ...
      'depthStencilAttachment': depthStencilView ? {
        ...
        'depthLoadValue': GPULoadOps[HEAPU32[descriptor+1]] || HEAPF32[descriptor+2],
        'depthStoreOp': GPUStoreOps[HEAPU32[descriptor+3]],
        'depthReadOnly': !!HEAPU32[descriptor+4],
        'stencilLoadValue': GPULoadOps[HEAPU32[descriptor+5]] || HEAPU32[descriptor+6],
    ...
    {{{ wdebugdir('descriptor'); }}}
    {{{ wdebuglog('JSON.stringify(descriptor)'); }}}

    var renderPassEncoder = wgpu[commandEncoder]['beginRenderPass'](descriptor);
    {{{ wdebuglog('`returned:`'); }}}
    {{{ wdebugdir('renderPassEncoder'); }}}
    return wgpuStore(renderPassEncoder);
#else
    // Manually Closure minify the above call - it is unable to do so.
  ...
  wgpu_command_encoder_begin_render_pass_1color_0depth: function(commandEncoder, descriptor) {
    ...
    var colorAttachmentsIdx = {{{ shiftPtr('HEAPU32[descriptor+1]', 2) }}},
      colorAttachmentsIdxDbl = {{{ shiftPtr('colorAttachmentsIdx + 4', 1) }}}; // Alias the view for HEAPF64.
  ...
  wgpu_command_encoder_zero_buffer: function(commandEncoder, destination, destinationOffset, size) {  // TODO: this function is untested. Write a test case
    {{{ wdebuglog('`wgpu_command_encoder_zero_buffer(commandEncoder=${commandEncoder}, destination=${destination}, destinationOffset=${destinationOffset}, size=${size})`'); }}}
    {{{ wassert('wgpu[commandEncoder] instanceof GPUCommandEncoder'); }}}
    {{{ wassert('wgpu[destination]'); }}}
    wgpu[commandEncoder]['fillBuffer'](wgpu[destination], destinationOffset, size);
  },
  ...
  wgpu_render_encoder_base_set_index_buffer__deps: ['$GPUIndexFormats'],
  ...
  wgpu_command_encoder_finish: function(commandEncoder) {
    ...
    var cmdBuffer = wgpu[commandEncoder]['finish']();
    {{{ wdebuglog('`returned:`'); }}}
    {{{ wdebugdir('cmdBuffer'); }}}
  ...
  wgpu_queue_copy_external_image_to_texture__deps: ['$wgpuReadGpuImageCopyTexture', '$GPUPredefinedColorSpaces'],
  wgpu_queue_copy_external_image_to_texture: function(queue, source, destination, copyWidth, copyHeight, copyDepthOrArrayLayers) {
    ...
    dest['colorSpace'] = GPUPredefinedColorSpaces[HEAP32[destination+6]];
