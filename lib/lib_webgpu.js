...
//  wgpu_is_presentation_context: function(o) { return wgpu[o] instanceof GPUPresentationContext; },
  ...
  wgpu_queue_write_texture: function(queue, destination, data, bytesPerBlockRow, blockRowsPerImage, writeWidth, writeHeight, writeDepthOrArrayLayers) { // TODO: this function is untested. Write a test case
    ...
    wgpu[queue]['writeTexture'](wgpuReadGpuImageCopyTexture(destination), HEAPU8, { offset: data, bytesPerRow: bytesPerBlockRow, rowsPerImage: blockRowsPerImage }, data, {'width': writeWidth, 'height': writeHeight, 'depthOrArrayLayers': writeDepthOrArrayLayers});

    // TODO: Chrome bug: Replace above with the form below. See https://github.com/juj/wasm_webgpu/issues/3
