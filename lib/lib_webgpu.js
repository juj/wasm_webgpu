...
//  $GPUTextureAspects: [, 'all', 'stencil-only', 'depth-only'],
  ...
  navigator_gpu_request_adapter_async__deps: ['$wgpuAllocId', '$dynCall'],
  ...
  wgpu_adapter_request_device_async__deps: ['wgpuFeatures', 'wgpu32BitLimitNames', '$wgpuReadI53FromU64HeapIdx'],
