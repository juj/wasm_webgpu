// Verifies that wgpu_render_pass_encoder_set_viewport() can be called within a render pass without producing an error.
...
void ObtainedWebGpuDevice(WGpuDevice device, void *userData)
{
  ...
  // Set a viewport - should not crash
  wgpu_render_pass_encoder_set_viewport(pass, 0.0f, 0.0f, 300.0f, 150.0f, 0.0f, 1.0f);
