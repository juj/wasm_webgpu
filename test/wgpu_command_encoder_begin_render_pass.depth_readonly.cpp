// Tests wgpu_command_encoder_begin_render_pass() with depthReadOnly=true in the
...
void ObtainedWebGpuDevice(WGpuDevice device, void *userData)
{
  ...
  // depthReadOnly pipeline must have depthWriteEnabled=false
  pipeDesc.depthStencil.format = WGPU_TEXTURE_FORMAT_DEPTH32FLOAT;
  ...
  dsDesc.format = WGPU_TEXTURE_FORMAT_DEPTH32FLOAT;
  ...
  dsAttach.depthReadOnly = WGPU_TRUE; // exercises the depthReadOnly=true code path
