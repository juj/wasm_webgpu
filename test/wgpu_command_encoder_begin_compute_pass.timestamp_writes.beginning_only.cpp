...
// (only beginningOfPassWriteIndex is set, endOfPassWriteIndex is -1).
// This exercises the 'if ((i = HEAP32[...+2]) >= 0)' false branch in
// $wgpuReadTimestampWrites for the compute pass end write — the complement of
// timestamp_writes.partial.cpp which tests beginning=-1, end>=0.
...
void ObtainedWebGpuDevice(WGpuDevice device, void *userData)
{
  ...
  passDesc.timestampWrites.endOfPassWriteIndex = -1;         // NOT written (exercises false branch)
