// Verifies that wgpu_is_render_pass_encoder() returns true for a WGpuRenderPassEncoder and false for a WGpuCommandEncoder.
...
void ObtainedWebGpuDevice(WGpuDevice device, void *userData)
{
  ...
  assert(!wgpu_is_render_pass_encoder(encoder)); // a command encoder is not a render pass encoder
