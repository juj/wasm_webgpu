// Tests creating a render pipeline with CULL_FRONT mode (culling front-facing polygons),
// exercising WGPU_CULL_MODE_FRONT in wgpuReadRenderPipelineDescriptor.
...
void ObtainedWebGpuDevice(WGpuDevice device, void *userData)
{
  ...
  desc.primitive.cullMode = WGPU_CULL_MODE_FRONT; // exercises front-face cull mode
