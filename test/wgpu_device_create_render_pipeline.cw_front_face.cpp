// Tests creating a render pipeline with clockwise (CW) front face winding,
// exercising the WGPU_FRONT_FACE_CW code path in wgpuReadRenderPipelineDescriptor.
...
void ObtainedWebGpuDevice(WGpuDevice device, void *userData)
{
  ...
  desc.primitive.frontFace = WGPU_FRONT_FACE_CW; // exercises the 'cw' front face path
