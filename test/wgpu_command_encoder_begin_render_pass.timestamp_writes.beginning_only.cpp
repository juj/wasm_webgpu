...
// (only the beginning-of-pass timestamp is written, end index set to -1).
// This exercises the 'if ((i = HEAP32[...+2]) >= 0)' false branch in
// $wgpuReadTimestampWrites for the end-of-pass write index, and the TRUE branch
// for the beginning-of-pass index — the complement of timestamp_writes.partial.cpp.
...
void ObtainedWebGpuDevice(WGpuDevice device, void *userData)
{
  ...
  // beginningOfPassWriteIndex = 0 (written), endOfPassWriteIndex = -1 (skipped).
  // This exercises the 'HEAP32[...+2] >= 0' FALSE branch for the end-of-pass write.
  passDesc.timestampWrites.querySet = querySet;
  passDesc.timestampWrites.beginningOfPassWriteIndex = 0;  // written at beginning
