// Tests wgpu_queue_copy_external_image_to_texture() with premultipliedAlpha=true
// on the destination, exercising the '!!HEAP32[destination+7]' true branch and
// a non-default colorSpace in lib_webgpu.js.
...
void ImageLoaded(WGpuImageBitmap bitmap, int width, int height, void *userData)
{
  ...
  dst.texture            = texture;
  dst.premultipliedAlpha = WGPU_TRUE; // exercises '!!HEAP32[destination+7]' true branch
