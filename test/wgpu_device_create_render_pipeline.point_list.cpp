// Tests creating a render pipeline with POINT_LIST topology and verifying it
// renders correctly. Also exercises the topology code path for POINT_LIST
// (value 1) and LINE_STRIP (value 3) to complement the existing LINE_LIST test.
...
void ObtainedWebGpuDevice(WGpuDevice device, void *userData)
{
  ...
  desc.primitive.topology = WGPU_PRIMITIVE_TOPOLOGY_POINT_LIST;
