// Verifies that wgpu_render_pass_encoder_set_stencil_reference() can be called within a render pass without producing an error.
...
void ObtainedWebGpuDevice(WGpuDevice device, void *userData)
{
  ...
  // Set stencil reference - should not crash
  wgpu_render_pass_encoder_set_stencil_reference(pass, 0xFF);
