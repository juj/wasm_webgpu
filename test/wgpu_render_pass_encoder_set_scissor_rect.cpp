// Verifies that wgpu_render_pass_encoder_set_scissor_rect() can be called within a render pass without producing an error.
...
void ObtainedWebGpuDevice(WGpuDevice device, void *userData)
{
  ...
  // Set a scissor rect - should not crash
  wgpu_render_pass_encoder_set_scissor_rect(pass, 0, 0, 300, 150);
