// Tests creating a WGpuBindGroupLayout with an unsigned integer texture sample
// type (WGPU_TEXTURE_SAMPLE_TYPE_UINT), exercising that branch in
...
void ObtainedWebGpuDevice(WGpuDevice device, void *userData)
{
  WGpuBindGroupLayoutEntry entry = {
    ...
    .layout.texture = {
      .sampleType = WGPU_TEXTURE_SAMPLE_TYPE_UINT,
  ...
  // Create an RGBA8UINT texture to bind
  WGpuTextureDescriptor tdesc = WGPU_TEXTURE_DESCRIPTOR_DEFAULT_INITIALIZER;
  tdesc.format = WGPU_TEXTURE_FORMAT_RGBA8UINT;
